...
- Keeping a simple research log - helps in troubleshooting  
...
- **Tip:** Consider two rival hypotheses for the same effect, then design your test so one could be contradicted by data  
...
- Types of studies:  
  ...
  * **Observational study** — you measure differences that already occur
...
- **Quantitative:** numeric, Discrete (counts), Continuous etc  
...
- Experiments, observations, surveys, sensors, etc  
- Emphasis on quality: sampling, calibration, clear protocols 
![](datacol.png){width=50%}

## Processing & Cleaning

- Standardise formats, handle missing values, detect outliers  
- Document every transformation— “garbage in, garbage out”  
![](outliers.jpg){width=50%}
